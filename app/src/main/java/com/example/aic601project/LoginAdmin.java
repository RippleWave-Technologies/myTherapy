...
public class LoginAdmin extends Fragment {
    ...
    private void attemptAdminLogin() {
        ...
        try {
            ...
            result = okHttpHandler.loginAdmin(url, Objects.requireNonNull(parameter1.getEditText()).getText().toString(), Objects.requireNonNull(parameter2.getEditText()).getText().toString());
        } catch (Exception e) {
            e.printStackTrace();
        }
